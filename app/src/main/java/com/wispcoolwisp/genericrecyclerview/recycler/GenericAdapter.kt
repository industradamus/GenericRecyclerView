...
abstract class GenericAdapter<T> : RecyclerView.Adapter<BaseViewHolder<*>>,
    ...
    override fun onGetSwipeReactionType(
        ...
        return if (hitTest(holder.swipeableContainerView, x, y)) {
    ...
    private fun unpinResultAction(position: Int): ResultAction<T>? {
